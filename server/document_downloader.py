...
def ping_biorxiv(doi):
    """
    This function pings biorxiv to see if doi exists
...
def ping_medrxiv(doi):
    """
    This function pings medrxiv to see if doi exists
    within their repository
